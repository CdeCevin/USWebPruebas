...
class FormularioDerivada extends StatefulWidget {
  final String id;

  FormularioDerivada({required this.id});

  @override
  _FormularioDerivadaState createState() => _FormularioDerivadaState();
}

class _FormularioDerivadaState extends State<FormularioDerivada> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: MyAppBar(title: 'Derivada', appBarHeight: appBarHeight),
