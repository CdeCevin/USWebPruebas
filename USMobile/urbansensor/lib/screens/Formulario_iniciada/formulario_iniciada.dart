...
class FormularioIniciada extends StatefulWidget {
  final String id;

  FormularioIniciada({required this.id});

  @override
  _FormularioIniciadaState createState() => _FormularioIniciadaState();
}

class _FormularioIniciadaState extends State<FormularioIniciada> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: MyAppBar(title: 'Iniciada', appBarHeight: appBarHeight),
